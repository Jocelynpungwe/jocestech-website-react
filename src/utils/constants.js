...
export const services = [
  {
    ...
    title: 'mission',
    text:
    'At Jocestech, our mission is to empower tech enthusiasts, professionals, and everyday users by providing a diverse range of cutting-edge products, unparalleled service, and expert guidance. We aim to foster a community where innovation meets accessibility, transforming the way people interact with technology.',
  },
  {
    id: 2,
    icon: <GiDiamondHard />,
    title: 'vision',
    text:
    'Our vision is to be the go-to destination for tech aficionados and consumers seeking top-tier devices, accessories, and expert advice. We aspire to create an ecosystem where convenience, innovation, and customer satisfaction converge, setting new standards in the tech ecommerce landscape.',
  },
  {
    id: 3,
    icon: <GiStabbedNote />,
